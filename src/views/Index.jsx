...
import infoCard from '../assets/img/component-info-card.png';
import componentInfo from '../assets/img/component-info-2.png';
        ...
        <div className="container mx-auto pb-64">
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
              <i className="fab fa-github text-gray-700 absolute -top-150-px -right-100 left-auto opacity-80 text-55"></i>
            </div>
          </div>
        </div>
      </section>
